...
local editor       = os.getenv("EDITOR") or "xed"
...
--              {description = "show main menu", group = "awesome"}),
    ...
    -- MPD control set volume at 60% default when toggling
    awful.key({ altkey, "Control" }, "Up",
        function ()            
            os.execute(string.format("amixer -q set %s 60%%", beautiful.volume.channel))
            beautiful.volume.update()
...
awful.util.spawn("/bin/bash /home/home/.config/awesome/startup.sh")
